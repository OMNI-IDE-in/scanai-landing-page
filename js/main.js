      ...
      <div class="product-card" data-category="${product.category}">
        ...
        <div class="product-body">
          ...
          <div class="product-actions">
            ...
            ` : `
              <button class="btn btn-primary btn-sm catalog-inquire-btn" data-product-name="${product.name}" data-specialty="${product.category === 'surgical-ai' ? 'Omni Rovis' : 'Arogya Connect'}">
                Inquire
              </button>
            `}
          </div>
  ...
  window.openProductModal = (productId) => {
    ...
    if (modalInquireBtn) {
      modalInquireBtn.onclick = (e) => {
        const pSpecialty = product.category === 'surgical-ai' ? 'Omni Rovis' : (product.category === 'hospital-os' ? 'Arogya Connect' : 'Surgical');
